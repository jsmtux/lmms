...
AmplifierEffect::AmplifierEffect( Model* parent, const PluginDescriptor::Key* key ) :
...
{
	return new AmplifierEffect( parent, static_cast<const Plugin::PluginDescriptor::Key *>( data ) );
}
