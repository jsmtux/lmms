...
{
public:
	TripleOscKnob( FloatModel* _model, QWidget * _parent ) :
	...
	InstrumentViewImpl( _instrument, _parent, true )
{
	...
	auto pm_osc1_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto am_osc1_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto mix_osc1_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto sync_osc1_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto fm_osc1_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto pm_osc2_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto am_osc2_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto mix_osc2_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto sync_osc2_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	auto fm_osc2_btn = new PixmapButton(this, new BoolModel(false, this));
	...
	for( int i = 0; i < NUM_OF_OSCILLATORS; ++i )
	{
		...
		auto sin_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto triangle_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto saw_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto sqr_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto moog_saw_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto exp_wave_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto white_noise_btn = new PixmapButton(this, new BoolModel(false, this));
		...
		auto uwb = new PixmapButton(this, new BoolModel(false, this));
		uwb->move( 233, btn_y );
