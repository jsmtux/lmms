	...
	EffectControlDialog( controls )
{
	...
	auto sampleDelayKnob = new TempoSyncKnob(knobBright_26, &controls->m_delayTimeModel, this);
	...
	auto lfoFreqKnob = new TempoSyncKnob(knobBright_26, &controls->m_lfoTimeModel, this);
	lfoFreqKnob->move( 11, 119 );
	lfoFreqKnob->setVolumeKnob( false );
	lfoFreqKnob->setLabel( tr( "RATE" ) );
	lfoFreqKnob->setHintText( tr ( "LFO frequency") + " ", " s" );

	auto lfoAmtKnob = new TempoSyncKnob(knobBright_26, &controls->m_lfoAmountModel, this);
