...
DispersionEffect::DispersionEffect(Model* parent, const PluginDescriptor::Key* key) :
...
{
	return new DispersionEffect(parent, static_cast<const Plugin::PluginDescriptor::Key *>(data));
}
