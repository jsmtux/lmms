...
LfoControllerDialog::LfoControllerDialog( LfoController * _model, QWidget * _parent ) :
	...
	m_lfo(_model)
{
	...
	m_baseKnob = new Knob( knobBright_26,  &_model->m_baseModel, this );

	m_baseKnob->setLabel( tr( "BASE" ) );
	m_baseKnob->move( CD_LFO_BASE_CD_KNOB_X, CD_LFO_CD_KNOB_Y );
	m_baseKnob->setHintText( tr( "Base:" ), "" );

	m_speedKnob = new TempoSyncKnob( knobBright_26, &_model->m_speedModel, this );
	...
	m_amountKnob = new Knob( knobBright_26, &_model->m_amountModel, this );
	m_amountKnob->setLabel( tr( "AMNT" ) );
	m_amountKnob->move( CD_LFO_AMOUNT_CD_KNOB_X, CD_LFO_CD_KNOB_Y );
	m_amountKnob->setHintText( tr( "Modulation amount:" ), "" );

	m_phaseKnob = new Knob( knobBright_26, &_model->m_phaseModel, this );
	...
	m_userWaveBtn = new PixmapButton( this, new BoolModel(false, this) );
	...
	m_waveBtnGrp = new automatableButtonGroup( &m_lfo->m_waveModel, this );
	...
	auto x1 = new PixmapButton(this, new BoolModel(false, this));
	...
	auto x100 = new PixmapButton(this, new BoolModel(false, this));
	...
	auto d100 = new PixmapButton(this, new BoolModel(false, this));
	...
	m_multiplierBtnGrp = new automatableButtonGroup( &_model->m_multiplierModel, this );
