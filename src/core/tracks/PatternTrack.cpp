...
void IPatternTrack::swapPatternTracks(ITrack* track1, ITrack* track2)
{
	PatternTrack::swapPatternTracks(static_cast<Track*>(track1), static_cast<Track*>(track2));
}

int IPatternTrack::getInfoMap(IPatternTrack* track)
{
	return PatternTrack::s_infoMap[dynamic_cast<PatternTrack*>(track)];
}
...
PatternTrack::~PatternTrack()
{
	Engine::audioEngine()->removePlayHandlesOfTypes( this,
					std::set{PlayHandleType::TypeNotePlayHandle
							,PlayHandleType::TypeInstrumentPlayHandle
							,PlayHandleType::TypeSamplePlayHandle} );
...
IClip* PatternTrack::createClip(const TimePos & pos)
{
...
IPatternTrack* IPatternTrack::findPatternTrack(int pattern_num)
{
	return PatternTrack::findPatternTrack(pattern_num);
}
