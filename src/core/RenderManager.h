...
public:
	...
	void renderTracks() override;

	void abortProcessing() override;

	IProjectRenderer* getProjectRenderer() override {
...
private:
	QString pathForTrack( const ITrack *track, int num );
	...
	QVector<ITrack*> m_tracksToRender;
	QVector<ITrack*> m_unmuted;
} ;
