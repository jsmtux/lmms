...
class LMMS_EXPORT PresetPreviewPlayHandle : public PlayHandle, public IPresetPreviewPlayHandle
{
public:
	PresetPreviewPlayHandle( const QString& presetFile, bool loadByPlugin = false, IDataFile *dataFile = 0 );
