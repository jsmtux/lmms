...
class LMMS_EXPORT SampleBuffer : public QObject, public ISampleBuffer, public sharedObject
{
	Q_OBJECT
	MM_OPERATORS
public:
	...
	inline const QString & audioFile() const override
	{
		return m_audioFile;
	}
	...
	inline f_cnt_t frames() const override
	{
		return m_frames;
	}
	...
	inline bool reversed() const override
	{
		return m_reversed;
	}
	...
	QString openAudioFile() const override;
	...
	inline sample_t userWaveSample(const float sample) const override
	{
...
public slots:
	void setAudioFile(const QString & audioFile) override;
