...
AutomationNode::AutomationNode(AutomationOwner* clip, float value, int pos) :
	m_clip(clip),
	m_pos(pos),
	m_inValue(value),
	m_outValue(value),
...
AutomationNode::AutomationNode(AutomationOwner* clip, float inValue, float outValue, int pos) :
	m_clip(clip),
	m_pos(pos),
	m_inValue(inValue),
	m_outValue(outValue),
...
void AutomationNode::setInValue(float value)
{
	...
	AutomationTimeMap::iterator it = tm.lowerBound(m_pos);
