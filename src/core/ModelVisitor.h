...
public:
	...
	virtual void visit(ComboBoxModelWrapper& m);
	virtual void visit(ITempoSyncKnobModelWrapper& m);
...
public:
	...
	virtual void visit(const ComboBoxModelWrapper& m);
	virtual void visit(const ITempoSyncKnobModelWrapper& m);
