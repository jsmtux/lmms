...
class LMMS_EXPORT MeterModel : public Model, public IMeterModel
{
	Q_OBJECT
...
public:
    ...
    IIntAutomatableModel & getNumeratorModel() override {
		return numeratorModel();
	}
	IIntAutomatableModel & getDenominatorModel() override {
