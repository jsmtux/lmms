...
class LMMS_EXPORT Controller : public Model, public JournallingObject, public IController
{
	Q_OBJECT
public:
	...
	bool isSampleExact() const override
	{
	...
	ControllerTypes type() const override
	{
		return( m_type );
	}
