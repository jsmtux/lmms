...
public:
	...
	///
	bool validate( QString extension ) override;

	QString nameWithExtension( const QString& fn ) const;

	void write( QTextStream& strm ) override;
	bool writeFile(const QString& fn, bool withResources = false) override;
